...
export const SECTION_3_RIDDLES: Riddle[] = [
  ...
  },
  {
    ...
    acceptedAnswers: ["indian space research organisation", "isro"],
    isCustom: true,
    imageUrls: [
